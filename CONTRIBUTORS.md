...
- **copilot-swe-agent[bot]** - AI-assisted development

---

## Kontakt Projekti / Project Contact
...
## Si të Kontribuoni / How to Contribute

1. Fork projektin
2. Krijo branch: `git checkout -b feature/emri-juaj`
3. Commit ndryshimet: `git commit -m "Shtova feature X"`
4. Push: `git push origin feature/emri-juaj`
5. Hap Pull Request
