  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      ...
      <div className="text-center mb-8">
        <Link href="/modules" className="text-cyan-400 hover:text-cyan-300 mb-4 inline-block">
          ← Back to Modules
        </Link>
      ...
      <div className="max-w-6xl mx-auto mb-8 grid grid-cols-4 gap-4">
        <div className="bg-blue-900/30 rounded-xl p-4 text-center border border-blue-500/30">
          <div className="text-3xl font-bold text-blue-400">{functions.filter(f => f.type === 'python').length}</div>
        ...
        <div className="bg-cyan-900/30 rounded-xl p-4 text-center border border-cyan-500/30">
          <div className="text-3xl font-bold text-cyan-400">{functions.length}</div>
      ...
      <div className="max-w-6xl mx-auto mb-6 flex gap-4">
        ...
        <input
          ...
          className="flex-1 bg-slate-700 text-white px-4 py-2 rounded-lg border border-slate-600 focus:border-cyan-500 focus:outline-none"
        />
      </div>
            ...
            {filteredFunctions.map((func, idx) => (
              <tr key={idx} className="border-t border-slate-700 hover:bg-slate-700/30 transition-colors">
                <td className="px-4 py-3">
                  <div className="font-mono text-cyan-400">{func.name}()</div>
      ...
      <div className="max-w-6xl mx-auto mt-8 flex justify-center gap-4">
        <button className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg font-semibold transition-all flex items-center gap-2">
          🐍 Export Python Stubs
        </button>
