...
// PRODUCTION: Use Docker DNS for internal container communication
// All containers must be in clisonix-unified network
const API_BASE = process.env.NEXT_PUBLIC_API_BASE || 'http://clisonix-api:8000';
const REPORTING_BASE = process.env.API_INTERNAL_URL || 'http://clisonix-api:8000';
